...
public class WebhookServiceImpl implements WebhookService {
    ...
    @Override
    public WebhookResponse.BatchProcessResponse processBatchWebhooks(List<Long> webhookIds, TAccountRequest accountRequest) {
    ...
    @Override
    @Transactional(readOnly = true)
    public WebhookResponse.WebhookStatistics getWebhookStatisticsByCarrier(Integer carrierId, TAccountRequest accountRequest) {
